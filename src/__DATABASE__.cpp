...
int main()
{
    ...
    do {
        ...
        if (choice == -1) {
            system("cls");
            std::cout << " Ошибка!\n Вы ввели недопустимый символ при выборе действия!\n Для выбора операции введите числа 1-7 или 0, для выхода\n";
        ...
        case 6:
            ...
            if(node = Departmentlist.findDepartmentByName(vec[dep - 1]))
                do {
                    ...
                    if (choice == -1) {
                        system("cls");
                        std::cout << " Ошибка!\n Вы ввели недопустимый символ при выборе действия!\n Для выбора операции введите числа 1-20 или 21, для выхода\n";
                        std::cout << "Нажмите \"Enter\" чтобы продолжить\n";
                        _getch();
                        continue;
                    }
...
//               -------------------Редактирование--------------------------
                    ...
                    case 6:
                        ...
                        percent = GetNum(-32678);
                        if (percent == -32678) {
                            system("cls");
                            std::cout << " Ошибка!\n Вы ввели недопустимый символ!\n Процент может принимать только числовые значения!\n";
                            std::cout << "Нажмите \"Enter\" чтобы продолжить\n";
                            _getch();
                            break;
                        }
